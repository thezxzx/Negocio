...
module.exports = __webpack_require__(/*! /home/zxzx/Escritorio/Ionic/negocio/src/main.ts */"zUnb");
...
const firebaseConfig = {
    apiKey: "AIzaSyCBwAwHWs5Ih9RXs-Zyaz1yNZLvFX3iTNU",
    authDomain: "negocio-311423.firebaseapp.com",
    projectId: "negocio-311423",
    storageBucket: "negocio-311423.appspot.com",
    messagingSenderId: "931827305790",
    appId: "1:931827305790:web:bb101b0785a7ff09aaf06f",
    measurementId: "G-JDV7LRN86G"
};
/*
...
let AuthService = class AuthService {
    constructor(afa, afs) {
        ...
        this.user$ = this.afa.authState.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["switchMap"])(user => {
            if (user) {
    ...
    registerWithEmail(email, password) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            try {
                ...
                console.log("🚀 ~ file: auth.service.ts ~ line 25 ~ AuthService ~ registerWithEmail ~ error", error);
            }
        });
    }
    sendVerificationEmail() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            try {
                return (yield this.afa.currentUser).sendEmailVerification();
            }
            catch (error) {
    ...
    addUser(user) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            try {
                yield this.afs.collection(this.usersCollection)
                    .add(user);
            }
            catch (error) {
...
AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [
            ...
            _angular_fire__WEBPACK_IMPORTED_MODULE_7__["AngularFireModule"].initializeApp(src_environments_environment__WEBPACK_IMPORTED_MODULE_11__["firebaseConfig"]),
...
const routes = [
    {
        path: 'register',
        loadChildren: () => __webpack_require__.e(/*! import() | auth-pages-register-register-module */ "auth-pages-register-register-module").then(__webpack_require__.bind(null, /*! ./auth/pages/register/register.module */ "jaOa")).then(m => m.RegisterPageModule)
    },
    {
        path: 'login',
    ...
    {
        path: 'show-products',
        loadChildren: () => __webpack_require__.e(/*! import() | products-pages-show-products-show-products-module */ "products-pages-show-products-show-products-module").then(__webpack_require__.bind(null, /*! ./products/pages/show-products/show-products.module */ "BR66")).then(m => m.ShowProductsPageModule)
    },
    {
        path: 'add-products',
        loadChildren: () => __webpack_require__.e(/*! import() | products-pages-add-products-add-products-module */ "products-pages-add-products-add-products-module").then(__webpack_require__.bind(null, /*! ./products/pages/add-products/add-products.module */ "9UkO")).then(m => m.AddProductsPageModule)
    }
];
